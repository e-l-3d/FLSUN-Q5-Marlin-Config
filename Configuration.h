...
#define STRING_CONFIG_H_AUTHOR "(E-L, FLSUN Q5)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.67 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PB2 // LED driving pin // bltouch
